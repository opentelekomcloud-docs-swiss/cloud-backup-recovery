...
project = 'Cloud Backup and Recovery'
otcdocs_repo_name = 'opentelekomcloud-docs-swiss/cloud-backup-recovery'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/cloud-backup-recovery/api-ref/'
otcdocs_doc_title = 'API Reference'
otcdocs_doc_type = 'api-ref'
otcdocs_service_category = 'storage'
otcdocs_service_title = 'Cloud Backup and Recovery'
otcdocs_service_type = 'cbr'
...
html_title = "Cloud Backup and Recovery - API Reference"
